...
export const brand = {
  ...
  // Logo officiel (logo-original) détouré et recoloré pour les fonds sombres :
  // le « M » décoratif en crème, « Sophie » en rosé. Header + image Open Graph.
  logo: { src: "/assets/logo.png", width: 408, height: 230 },
};
